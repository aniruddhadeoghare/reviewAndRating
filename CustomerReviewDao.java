...
public abstract interface CustomerReviewDao
{
  ...
  // Updated By Aniruddha Deoghare
  
  public abstract long getTotalNumOfCustReview(ProductModel product, double minRating, double maxRating, List<String> cursedWords)
}
